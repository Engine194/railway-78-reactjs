      ...
      <div className="user-form-inner-wrapper">
        <form className="user-form" onSubmit={handleSubmit}>
          ...
          <div className="form-row"  >
            ...
            <input type="date" value={user.dob} onChange={handleChangeFactory('dob')}/>
          </div>

          

          <textarea rows={5} value={user.favorite} onChange={handleChangeFactory('favorite')} placeholder="Favorite animal..."/>
